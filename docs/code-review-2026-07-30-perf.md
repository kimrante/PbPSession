...
> **반영 현황 (같은 날 처리)**: P1·P2·P3(세션 캐시)·P4·P5·P6·P7·P8·P9·M1·M2·M3(트레이 훅)·
> F1·F2·F3(아바타 인코딩 memoize, runBlockingIo 주석 정정) — 완료.
> 잔여: P3의 "근본 수정"(재시작에도 유지되는 파일 캐시), M3의 LRU 상한,
> F3의 uploadedAvatars 영속화·FCM 토큰 방별 쓰기·알림 아바타 캐시·ChatScreen O(N) remember —
> 낮은 우선순위로 보류. 콘솔 확인 1건(DB 리전)은 사용자 확인 필요.
