...
> **적용 현황** (2026-08-12)
> - v0.19.0 — SV1·SV4·SV7·SV11·SV12 (앱 코드, 배포 불필요)
> - v0.20.0 — SV2·SV3(일부)·SV5·SV6·SV8·SV9·SV10 (`firestore.rules`·`functions/index.js` 배포 필요.
>   절차와 남은 위험은 docs/deploy.md "v0.20.0에서 바뀐 것")
> - **미적용** — SV2의 멤버 수 서버 강제(방 ID를 아는 제3자의 가입), SV3의 App Check
>   (강제 시 데스크톱이 막힌다). 사유는 docs/deploy.md에.
